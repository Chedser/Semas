...
CREATE TABLE IF NOT EXISTS wall_message_like (
	...
	FOREIGN KEY (messageId) REFERENCES wall_message(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS forum_message_like (
	id INTEGER PRIMARY KEY AUTOINCREMENT,
	likerId INTEGER NOT NULL,
	messageId  INTEGER NOT NULL,
	date DATETIME DEFAULT CURRENT_TIMESTAMP,	
	u_time INTEGER NOT NULL,
	FOREIGN KEY (likerId) REFERENCES user(id),
	FOREIGN KEY (messageId) REFERENCES forum_message(id) ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS forum_main_message_like (
	id INTEGER PRIMARY KEY AUTOINCREMENT,
	likerId INTEGER NOT NULL,
